...
//        });
        ...
        Commands.put("export-autopdf", (Command) (String... args) -> {
            EXPORT_AUTOPDF();
        });
        
        Commands.put("export-gif", (Command) (String... args) -> {
            EXPORT_GIF();
        });
        
        Commands.put("export-jar", (Command) (String... args) -> {
            EXPORT_JAR();
        });
        
        Commands.put("export-png", (Command) (String... args) -> {
            EXPORT_PNG();
        });
